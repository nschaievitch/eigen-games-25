...
# RPC URL for the desired network (e.g., Sepolia or Holesky)
RPC=https://rpc.ankr.com/eth_sepolia 

# Generate private keys and addresses for three operator accounts
...
# Transfer 0.02 ETH to each operator address using the deployer's private key
cast send \
    --rpc-url $RPC \
